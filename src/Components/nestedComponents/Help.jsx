      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-pink-100 p-6 rounded-lg shadow">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">How do I contact support?</h2>
            <p className="text-gray-600">You can contact our support team through the 'Contact Us' page or by emailing help@example.com. We are here 24/7 to assist you.</p>
          </div>
        </div>
      </div>
    </div>

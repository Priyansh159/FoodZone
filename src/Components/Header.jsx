...
const Header = ({setAllRestArr, resturDetails}) => {
    return(
        <div className="sticky top-0 w-full z-10 flex items-center justify-between px-5  py-2 bg-white text-black dark:bg-blue-950 dark:text-white  text-xl">
        ...
        <Search setAllRestArr={setAllRestArr} resturDetails={resturDetails}/>
        <Link to="/help"><span className="flex ml-4 items-center">
            <LiaHandsHelpingSolid />
            <h1 className="ml-2">Help</h1>
        </span></Link>
        <Link to="/offer"><span className="flex ml-4 items-center">
            <BiSolidOffer />
            <h1 className="ml-2">Offer</h1>
        </span></Link>
        <Link to="/signin"><span className="flex ml-4 items-center">
            <PiSignIn />
